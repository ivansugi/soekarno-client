...
media = settings_processor('ADMIN_MEDIA_PREFIX', 'MEDIA_URL', 'STATIC_MEDIA_URL', 'SSO_URL', 'SSO_CLIENT')
media.__doc__ = """A context processor which adds the values of the settings
``ADMIN_MEDIA_PREFIX``, ``STATIC_MEDIA_URL`` and ``MEDIA_URL`` to a ``RequestContext``."""
